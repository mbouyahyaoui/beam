 ...
 */
public class FlinkParDoBoundWrapper<InputT, OutputT> extends FlinkAbstractParDoWrapper<InputT,
    OutputT, OutputT> {

  public FlinkParDoBoundWrapper(PipelineOptions options, WindowingStrategy<?, ?>
      windowingStrategy, OldDoFn<InputT, OutputT> doFn) {
  ...
  public void outputWithTimestampHelper(WindowedValue<InputT> inElement, OutputT output, Instant
      timestamp, Collector<WindowedValue<OutputT>> collector) {
  ...
  @Override
  public <T> void sideOutputWithTimestampHelper(WindowedValue<InputT> inElement, T output,
                                                Instant timestamp,
  ...
  public WindowingInternals<InputT, OutputT> windowingInternalsHelper(
    ...
    return new WindowingInternals<InputT, OutputT>() {
      ...
      @Override
      public void outputWindowedValue(OutputT output, Instant timestamp, Collection<? extends
