...
public class StateCheckpointWriter {
  ...
  public static StateCheckpointWriter create(
      AbstractStateBackend.CheckpointStateOutputView output) {
  ...
  ///////// Creating the serialized versions of the different types of state held by beam
